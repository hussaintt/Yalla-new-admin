...
export default function ClientsPage() {
  ...
  const updateStatus = useMutation({
    ...
    onError: (error) => {
      toast.error(error instanceof Error ? error.message : "تعذر تحديث العميل");
    },
  });
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="العملاء"
        description="عرض وإدارة حسابات العملاء المسجلين بالمنصة وإيقاف أو إعادة تنشيط الحسابات."
      />
      ...
      <ActionDialog
        ...
        title={pendingAction?.status === "SUSPENDED" ? "إيقاف العميل" : "إعادة تنشيط العميل"}
        description={
          pendingAction
